...
Given this new notation, we can restate and summarise the theorems described in \Cref{sec:ass} and \Cref{sec:abs}, that will be the starting point for the adaptive variance case described in the next section:
